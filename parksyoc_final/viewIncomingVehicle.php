...
<body>
  ...
  <div class="jumbutron-section">
    <div class="mt-4 p-5 bg-success text-white rounded">
      <h1>View current parked vehicle</h1>
      <p>This is where you can update the current parked vehicle to outgoing vehicle status.</p>
    </div>
  </div>

  <div class="goback">
    <a href="./manageIn.php" class="btn btn-secondary">Go back to manage in vehicles</a>
  </div>
