...
$statement = $pdo->query("SELECT * FROM membership WHERE mmbr_stts = '' AND appntmnt_stts = '' ORDER BY date(appntmnt_date) = CURRENT_DATE() DESC");
$statement->execute();
...
<head>
  ...
  <title>ParkSyOC - Pending Membership</title>
</head>
<body>
  <!-- Navigation -->
  ...
  <div class="jumbutron-section mb-5">
    <div class="mt-4 p-5 bg-success text-white rounded">
      <h1>Pending application of memberships</h1>
      <p>Users and admin can add membership in ParkSyOC</p>
    </div>
  </div>
          ...
          <tr class="">
            ...
            <td>
              <form action="" method="POST">
                ...
                <a href="./fromPndngMmbrshp.php?<?php echo "member_id=" . $row['id'] ?>" class="btn btn-sm btn-outline-primary">Confirmation</a>
                <a href="./pndngMmbrshpDelete.php?<?php echo "deleteId=" . $row['id'] ?>" class="btn btn-sm btn-outline-danger" name="delete">Delete</a>
              </form>
            </td>
          </tr>
          <?php endforeach; ?>
