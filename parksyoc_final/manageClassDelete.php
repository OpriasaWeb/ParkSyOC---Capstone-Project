...
if(isset($_POST['delete'])){
  ...
  $sql = "DELETE FROM vehicle_class WHERE id = :classId ";
  ...
  <div class="container text-center ">
    <div class="card mt-10">
      ...
      <div class="card-body">
        ...
        <p class="card-text">Are you sure to delete this vehicle class?</p>
        <form action="" method="post">
          <a href="./manageClass.php" class="btn btn-sm btn-outline-primary">Cancel</a>
