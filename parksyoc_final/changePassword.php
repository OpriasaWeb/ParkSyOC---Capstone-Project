...
<body>
        ...
        <ul class="navbar-nav justify-content-center">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <li><a class="dropdown-item" href="">Book vehicle</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              <li><a class="dropdown-item" href="">Manage membership</a></li>
  ...
  <div class="jumbutron-section">
    <div class="mt-4 p-5 bg-success text-white rounded">
      ...
      <p>First, enter the current password and follow up with the new password.</p>
    </div>
  </div>
  <!-- Jumbotron section -->
  ...
  <div class="add-vehicle">
    ...
    <div class="input-group mb-3">
      ...
      <input type="text" class="form-control" placeholder="Current password" aria-label="" aria-describedby="button-addon2">
    </div>

    <div class="input-group mb-3">
      <label>New password</label>
      <input type="text" class="form-control" placeholder="New password" aria-label="" aria-describedby="button-addon2">
    </div>

    <div class="input-group mb-3">
      <label>Confirm password</label>
      <input type="text" class="form-control" placeholder="Confirm password" aria-label="" aria-describedby="button-addon2">
    </div>

    <div class="button-sbmt">
      <button class="btn btn-outline-primary mx-auto" type="button" id="button-addon2">Change</button>
    </div>
  </div>
  <!-- Add vehicle section -->
