...
if(isset($_POST['book'])){
  ...
  $statement2 = $pdo->prepare("INSERT INTO add_vehicle (mmbrshp_id, ownr_name, cstmr_type, vhcl_type, email, plate_no, cntct_no, bkng_dt, bkng_time)
  VALUES (:mmbrshp_id, :ownr_name, :cstmr_type, :vhcl_type, :email, :plate_no, :cntct_no, :bkng_dt, :bkng_time)");

  $statement2->bindValue(':mmbrshp_id', $id_mmbrshp);
  ...
  if($statement){
    $_SESSION['message'] = "Member book successfully!";
    header('Location:./newBooking.php');
    exit(0);
  } else{
    ...
    <div class="container mt-3">
      ...
      <form action="" method="POST">
        <div class="form-floating mb-2">
          ...
          value="<?= $mmbrshp_id ?>" name="member_id">
          ...
          <div class="row">
            ...
            <div class="col-8 mb-3">
              <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                <input type="radio" class="btn-check" name="cstmr" id="cstmr1" autocomplete="off" value="Member" onclick="paymentReminder(0)" checked required>
                <label class="btn btn-outline-primary" for="cstmr1">Member</label>

                <input type="radio" class="btn-check" name="cstmr" id="cstmr2" autocomplete="off" value="Hospital" onclick="paymentReminder(1)" disabled>
                ...
                <input type="radio" class="btn-check" name="cstmr" id="cstmr4" autocomplete="off" value="VIP" onclick="paymentReminder(3)" disabled>
        ...
        <div class="form-floating mb-2">
          <input type="email" class="form-control" id="floatingPassword" name="email_user" value="<?= $email ?>" required>
